...
public class EstadoInscripcion implements java.io.Serializable {
    ...
    public static final EstadoInscripcion Aceptada = new EstadoInscripcion(_Aceptada);
    public static final EstadoInscripcion Rechazada = new EstadoInscripcion(_Rechazada);
