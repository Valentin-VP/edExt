	                        ...
	                        <div class="card-title mb-4">
	                            <div class="d-flex justify-content-start">
	                                ...
	                                <div class="userData ml-3">
	                                    <h2 class="d-block" style="font-size: 1.5rem; font-weight: bold"><a href="#"><%=u.getNombre() + " " + u.getApellido() %></a></h2>
										<h3 class="d-block" style ="font-size: 1rem; font-weight: bold"><label ><%="aca vendria el tipo de usuario" %></label></h3>
	                                </div>
	                                <div class="ml-auto">
